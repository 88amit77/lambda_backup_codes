        ...
        if len(productQuery) != 0:
            ...
            for single_record in results_data:
                ...
                try:
                    ...
                    # print(zone)
                    zone.to_csv('/tmp/z1.csv', index=False)
                    ...
                    # print("sql==",sql)
                    sql['zone'] = 0
                    sql.to_csv('/tmp/z.csv', index=False)

                    df115 = pd.read_csv("/tmp/z.csv")
                    df125 = pd.read_csv("/tmp/z1.csv")
                    ...
                    df2252.to_csv('/tmp/z2.csv', index=False)

                    ## warehouse belongs to north zone code ==2
                    wb = pd.read_csv('/tmp/z2.csv')
                    north = wb[wb['zone'] == 1]
                    ...
                    d.to_csv('/tmp/z30.csv', index=False)
                ...
                d.to_csv('/tmp/z19.csv', index=False)
                final = pd.read_csv('/tmp/z19.csv')
                final['a'] = 0.15 * (
                ...
                final.to_csv('/tmp/z22.csv', index=False)
                final1 = pd.read_csv('/tmp/z22.csv')
                final1.created_at.fillna(dt.datetime.now(), inplace=True)
                final1.updated_at.fillna(dt.datetime.now(), inplace=True)
                final1.to_csv('/tmp/z23.csv', index=False)
                final2 = pd.read_csv('/tmp/z23.csv')
                ...
                final2.to_csv('/tmp/z24.csv', index=False)
                final4 = pd.read_csv('/tmp/z24.csv')
                # ###to fill all null or empty value with 0

                final4.to_csv('/tmp/z25.csv', index=False)
                final5 = pd.read_csv('/tmp/z25.csv')
                ...
                ##old code ends
                # new code
                final51['north_zone_requirement'] = (
                ((final51['north_zone_requirement'] * final51['days_of_cover']) / 90))
                final51['east_zone_requirement'] = (
                ((final51['east_zone_requirement'] * final51['days_of_cover']) / 90))
                final51['south_zone_requirement'] = (
                ((final51['south_zone_requirement'] * final51['days_of_cover']) / 90))
                final51['west_zone_requirement'] = (
                ((final51['west_zone_requirement'] * final51['days_of_cover']) / 90))
                ...
                final51['north_zone_requirement'] = final51['north_zone_requirement'] - final51['north_zone_stock']
                final51['east_zone_requirement'] = final51['east_zone_requirement'] - final51['east_zone_stock']
                final51['south_zone_requirement'] = final51['south_zone_requirement'] - final51['south_zone_stock']
                final51['west_zone_requirement'] = final51['west_zone_requirement'] - final51['west_zone_stock']
                ...
                final51.to_csv('/tmp/z26.csv', index=False)
                ...
                try:
                    ...
                    df12 = pd.read_csv('/tmp/z26.csv')
                    dd1 = df12[~df12['product_id_id'].isin(product_id_list)]
                    dd1.to_csv('/tmp/z31.csv', index=False)
                ...
                try:
                    ...
                    df11 = pd.read_csv('/tmp/z26.csv')
                    dd = df11[df11['product_id_id'].isin(product_id_list)]
                    dd.to_csv('/tmp/z30.csv', index=False)
                ...
                if dd.empty:
                    ...
                    for index, row in iters:
                        ...
                        #      row['north_zone_excess_stock'], row['south_zone_excess_stock'], row['east_zone_excess_stock'],
                        #      row['west_zone_excess_stock'], row['created_at'], row['updated_at'],
                        #      row['product_id_id']])
                        # conn1.commit()
                        cur1.execute(
                ...
                d11 = pd.read_csv('/tmp/z26.csv')
                d22 = d11.iloc[0:0]
                # after every itration delete all rows
                d22.to_csv('/tmp/z26.csv', index=False)
